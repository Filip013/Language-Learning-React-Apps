...
const APPS_TO_MIGRATE = [
    ...
    { id: 'french-master', name: 'French', collections: ['episodes', 'progress'], docs: ['database/lexicon'] },
    ...
    { id: 'norwegian-master', name: 'Norwegian', collections: ['episodes', 'progress'], docs: ['database/lexicon'] },
