// src/components/course/TestTab.jsx
import React, { useState, useEffect, useRef, useCallback } from 'react';
import { 
  PenTool, RotateCcw, Volume2, Loader2, 
...
export default function TestTab({ isActive, isDarkMode, activeEpisode, progressState, updateFirebase, handleSpeak, stopSpeak, config, handleOpenNote, onTabNext, onTabPrev }) {
